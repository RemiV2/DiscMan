...
/* harmony import */ var _helpers_switchTab_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/switchTab.js */ "./js/helpers/switchTab.js");
...
for (const tab of tabs) {
  ...
  tab.addEventListener('click', () => {
    console.log('click')
    Object(_helpers_switchTab_js__WEBPACK_IMPORTED_MODULE_2__["default"])(tab.getAttribute('id'))
  })
}
...
/***/ "./js/components/createSongCard.js":
/*!*****************************************!*\
  !*** ./js/components/createSongCard.js ***!
  \*****************************************/
...
// module
exports.push([module.i, "html, body, div, span, applet, object, iframe, h1, h2, h3, h4, h5, h6, p, blockquote, pre, a, abbr, acronym, address, big, cite, code, del, dfn, em, img, ins, kbd, q, s, samp, small, strike, strong, sub, sup, tt, var, b, u, i, center, dl, dt, dd, ol, ul, li, fieldset, form, label, legend, table, caption, tbody, tfoot, thead, tr, th, td, article, aside, canvas, details, embed, figure, figcaption, footer, header, hgroup, menu, nav, output, ruby, section, summary, time, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: 100%;\n  font: inherit;\n  vertical-align: baseline;\n  box-sizing: border-box; }\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure, footer, header, hgroup, menu, nav, section {\n  display: block; }\n\nbody {\n  line-height: 1; }\n\nol, ul {\n  list-style: none; }\n\nblockquote, q {\n  quotes: none; }\n\nblockquote:before, blockquote:after, q:before, q:after {\n  content: '';\n  content: none; }\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0; }\n\nheader {\n  padding: 10px;\n  background-image: linear-gradient(-180deg, rgba(237, 234, 237, 0.45) 0%, rgba(223, 219, 223, 0.45) 100%);\n  -webkit-app-region: drag;\n  border-bottom: 1px solid #cdcdcd;\n  height: 82px; }\n  header #appTitle {\n    text-align: center;\n    font-size: 14px; }\n  header ul.centeredPills {\n    display: flex;\n    justify-content: space-around;\n    margin-top: 14px; }\n    header ul.centeredPills li.tab {\n      background: rgba(243, 243, 243, 0);\n      box-sizing: border-box;\n      -webkit-app-region: no-drag;\n      margin-top: 4px; }\n      header ul.centeredPills li.tab:hover {\n        background: rgba(243, 243, 243, 0); }\n      header ul.centeredPills li.tab:focus {\n        outline: 1px solid #333; }\n      header ul.centeredPills li.tab a {\n        padding: 7px 20px;\n        font-size: 13px;\n        text-transform: uppercase;\n        text-decoration: none;\n        cursor: default;\n        color: #333;\n        transition-duration: .2s;\n        border-radius: 5px; }\n        header ul.centeredPills li.tab a:hover {\n          background: rgba(243, 243, 243, 0.3);\n          padding: 7px 20px; }\n    header ul.centeredPills li.tab.active {\n      background: #f3f3f3;\n      color: #333; }\n      header ul.centeredPills li.tab.active a {\n        background: #f3f3f3;\n        color: #333;\n        border: 0.5px solid #f4f4f4;\n        padding: 7px 20px;\n        font-size: 13px; }\n        header ul.centeredPills li.tab.active a:focus, header ul.centeredPills li.tab.active a:hover {\n          background: #f3f3f3;\n          color: #333; }\n\n.firstStart {\n  text-align: center;\n  height: calc(100vh - 79px);\n  display: flex;\n  padding: 10px 50px;\n  flex-direction: column;\n  justify-content: center;\n  z-index: 100;\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  background: #f3f3f3; }\n  .firstStart p {\n    margin: 25px auto 0 auto; }\n\n.firstStart.draggedOver {\n  background: #4181ec;\n  color: #f3f3f3; }\n  .firstStart.draggedOver button {\n    visibility: hidden; }\n\n.player {\n  height: 82px;\n  width: 100%;\n  position: fixed;\n  bottom: 0;\n  transform: translateY(90px);\n  transition: 0.2s transform;\n  will-change: transform;\n  flex-direction: row;\n  justify-content: space-between;\n  padding: 10px 10px 10px 0;\n  color: #333;\n  background-image: linear-gradient(-180deg, rgba(235, 234, 237, 0.45) 0%, rgba(223, 219, 223, 0.45) 100%);\n  display: none; }\n  .player #timeControl {\n    width: 100%;\n    position: absolute;\n    bottom: 82px;\n    z-index: 300;\n    -webkit-appearance: none;\n    width: 100%;\n    border-radius: 4px;\n    height: 4px;\n    background-color: #f3f3f3;\n    box-shadow: 0 -1px 1px 0 rgba(0, 0, 0, 0.25);\n    outline: none; }\n  .player .art {\n    background: teal;\n    background-size: cover;\n    margin-left: 10px;\n    width: 62px;\n    height: 62px;\n    min-width: 62px;\n    border-radius: 2px; }\n  .player .data {\n    display: flex;\n    flex: 1;\n    margin: 0 6px;\n    flex-direction: column;\n    justify-content: space-between;\n    min-width: 0; }\n    .player .data .title {\n      margin-bottom: 6px;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis; }\n    .player .data .artist {\n      opacity: .6;\n      margin-bottom: 4px;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis; }\n    .player .data .mediaControls {\n      display: flex;\n      flex-direction: row;\n      justify-content: space-between;\n      flex-wrap: wrap;\n      width: 100px;\n      flex: 1;\n      height: 25px; }\n      .player .data .mediaControls div {\n        width: 25px;\n        height: 25px; }\n      .player .data .mediaControls .previous {\n        background: url(" + escape(__webpack_require__(/*! ../images/previous_light.png */ "./images/previous_light.png")) + ");\n        background-size: cover; }\n      .player .data .mediaControls .playpause {\n        background: url(" + escape(__webpack_require__(/*! ../images/play_light.png */ "./images/play_light.png")) + ");\n        background-size: cover; }\n      .player .data .mediaControls .playpause.playing {\n        background: url(" + escape(__webpack_require__(/*! ../images/pause_light.png */ "./images/pause_light.png")) + ");\n        background-size: cover; }\n      .player .data .mediaControls .next {\n        background: url(" + escape(__webpack_require__(/*! ../images/next_light.png */ "./images/next_light.png")) + ");\n        background-size: cover; }\n  .player .volume {\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between; }\n    .player .volume input {\n      -webkit-appearance: slider-vertical;\n      height: 80px;\n      align-self: flex-end;\n      width: 20px; }\n    .player .volume div {\n      width: 25px;\n      height: 25px;\n      background: url(" + escape(__webpack_require__(/*! ../images/soundon_light.png */ "./images/soundon_light.png")) + ");\n      background-size: cover;\n      align-self: flex-end;\n      width: 20px;\n      margin-bottom: 3px; }\n    .player .volume div.muted {\n      background: url(" + escape(__webpack_require__(/*! ../images/soundoff_light.png */ "./images/soundoff_light.png")) + ");\n      background-size: cover; }\n\n.card {\n  height: 60px;\n  padding: 10px;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  color: #333; }\n  .card:nth-child(even) {\n    background: #ececec; }\n  .card .card__art {\n    height: 40px;\n    width: 40px;\n    background: #ddaaaa;\n    background-size: cover;\n    border-right: 3px;\n    margin-right: 10px; }\n  .card .card__info {\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    padding: 1px 0;\n    min-width: 0; }\n    .card .card__info p {\n      margin: 0;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis; }\n    .card .card__info .card__details {\n      opacity: .6; }\n\nbody {\n  margin: 0;\n  font: caption;\n  background: rgba(243, 243, 243, 0);\n  user-select: none;\n  cursor: default;\n  outline: none; }\n  body .content {\n    min-height: calc(100vh - 82px);\n    top: 82px;\n    bottom: 0;\n    background: #f3f3f3;\n    width: 100vw;\n    position: fixed;\n    overflow-y: scroll;\n    display: none; }\n    body .content.active {\n      display: block; }\n", "", {"version":3,"sources":["/Users/remi/gdrive/Code/DiscMan/sass/sass/_reset.sass","/Users/remi/gdrive/Code/DiscMan/sass/sass/_header.sass","/Users/remi/gdrive/Code/DiscMan/sass/sass/style.sass","/Users/remi/gdrive/Code/DiscMan/sass/sass/_first-start.sass","/Users/remi/gdrive/Code/DiscMan/sass/sass/_player.sass","/Users/remi/gdrive/Code/DiscMan/sass/sass/_cards.sass"],"names":[],"mappings":"AAAA;EACC,UAAS;EACT,WAAU;EACV,UAAS;EACT,gBAAe;EACf,cAAa;EACb,yBAAwB;EACxB,uBAAsB,EAAG;;AAE1B,iDAAiD;AACjD;EACC,eAAc,EAAG;;AAElB;EACC,eAAc,EAAG;;AAElB;EACC,iBAAgB,EAAG;;AAEpB;EACC,aAAY,EAAG;;AAEhB;EACC,YAAW;EACX,cAAa,EAAG;;AAEjB;EACC,0BAAyB;EACzB,kBAAiB,EAAG;;AC5BrB;EACE,cAAa;EACb,yGAAkG;EAClG,yBAAwB;EACxB,iCAAuD;EACvD,aAAY,EA+C0B;EApDxC;IAQI,mBAAkB;IAClB,gBAAe,EAAG;EATtB;IAYI,cAAa;IACb,8BAA6B;IAC7B,iBAAgB,EAsCkB;IApDtC;MAiBM,mCAAkC;MAClC,uBAAsB;MACtB,4BAA2B;MAC3B,gBAAe,EAiBa;MArClC;QAsBQ,mCAAkC,EAAG;MAtB7C;QAwBQ,wBCxBU,EDwBwB;MAxB1C;QA2BQ,kBAAiB;QACjB,gBAAe;QACf,0BAAyB;QACzB,sBAAqB;QACrB,gBAAe;QACf,YChCU;QDiCV,yBAAwB;QACxB,mBAAkB,EAGM;QArChC;UAoCU,qCAAoC;UACpC,kBAAiB,EAAG;IArC9B;MAwCM,oBCvCgC;MDwChC,YCzCY,EDoDkB;MApDpC;QA6CQ,oBC5C8B;QD6C9B,YC9CU;QD+CV,4BAAkD;QAClD,kBAAiB;QACjB,gBAAe,EAGW;QApDlC;UAmDU,oBClD4B;UDmD5B,YCpDQ,EDoDc;;AEpDhC;EACE,mBAAkB;EAClB,2BAA0B;EAC1B,cAAa;EACb,mBAAkB;EAClB,uBAAsB;EACtB,wBAAuB;EACvB,aAAY;EACZ,gBAAe;EACf,UAAS;EACT,YAAW;EACX,oBDVoC,ECaL;EAdjC;IAcI,yBAAwB,EAAG;;AAE/B;EACE,oBDfc;ECgBd,eDjBoC,ECoBX;EAL3B;IAKI,mBAAkB,EAAG;;ACrBzB;EACE,aAAY;EACZ,YAAW;EACX,gBAAe;EACf,UAAS;EACT,4BAA2B;EAC3B,2BAA0B;EAC1B,uBAAsB;EACtB,oBAAmB;EACnB,+BAA8B;EAC9B,0BAAyB;EACzB,YFXgB;EEYhB,yGAAwG;EACxG,cAAa,EAiGoB;EA9GnC;IAgBI,YAAW;IACX,mBAAkB;IAClB,aAAY;IACZ,aAAY;IACZ,yBAAwB;IACxB,YAAW;IACX,mBAAkB;IAClB,YAAW;IACX,0BFvBkC;IEwBlC,6CAA4C;IAC5C,cAAa,EAAG;EA1BpB;IA8BI,iBAAgB;IAChB,uBAAsB;IACtB,kBAAiB;IACjB,YAAW;IACX,aAAY;IACZ,gBAAe;IACf,mBAAkB,EAAG;EApCzB;IAuCI,cAAa;IACb,QAAO;IACP,cAAa;IACb,uBAAsB;IACtB,+BAA8B;IAE9B,aAAY,EAyCqB;IAtFrC;MAgDM,mBAAkB;MAClB,oBAAmB;MACnB,iBAAgB;MAChB,wBAAuB,EAAG;IAnDhC;MAsDM,YAAW;MACX,mBAAkB;MAClB,oBAAmB;MACnB,iBAAgB;MAChB,wBAAuB,EAAG;IA1DhC;MA6DM,cAAa;MACb,oBAAmB;MACnB,+BAA8B;MAC9B,gBAAe;MACf,aAAY;MACZ,QAAO;MACP,aAAY,EAmBiB;MAtFnC;QAsEQ,YAAW;QACX,aAAY,EAAG;MAvEvB;QA0EQ,0CAA6C;QAC7C,uBAAsB,EAAG;MA3EjC;QA8EQ,0CAAyC;QACzC,uBAAsB,EAAG;MA/EjC;QAiFQ,0CAA0C;QAC1C,uBAAsB,EAAG;MAlFjC;QAqFQ,0CAAyC;QACzC,uBAAsB,EAAG;EAtFjC;IAyFI,cAAa;IACb,uBAAsB;IACtB,+BAA8B,EAmBD;IA9GjC;MA8FM,oCAAmC;MACnC,aAAY;MACZ,qBAAoB;MACpB,YAAW,EAAG;IAjGpB;MAoGM,YAAW;MACX,aAAY;MACZ,0CAA4C;MAC5C,uBAAsB;MACtB,qBAAoB;MACpB,YAAW;MACX,mBAAkB,EAAG;IA1G3B;MA6GM,0CAA6C;MAC7C,uBAAsB,EAAG;;AC9G/B;EACE,aAAY;EACZ,cAAa;EACb,cAAa;EACb,oBAAmB;EACnB,+BAA8B;EAC9B,YHNgB,EGmCM;EAnCxB;IAQI,oBAA2C,EAAG;EARlD;IAWI,aAAY;IACZ,YAAW;IAEX,oBAAmB;IACnB,uBAAsB;IACtB,kBAAiB;IACjB,mBAAkB,EAAG;EAjBzB;IAoBI,QAAO;IACP,cAAa;IACb,uBAAsB;IACtB,+BAA8B;IAC9B,eAAc;IAEd,aAAY,EASM;IAnCtB;MA6BM,UAAS;MACT,oBAAmB;MACnB,iBAAgB;MAChB,wBAAuB,EAAG;IAhChC;MAmCM,YAAW,EAAG;;AHzBpB;EACE,UAAS;EACT,cAAa;EAEb,mCAAkC;EAClC,kBAAiB;EACjB,gBAAe;EACf,cAAa,EAYY;EAnB3B;IAUI,+BAA8B;IAC9B,UAAS;IACT,UAAS;IACT,oBAA8B;IAC9B,aAAY;IACZ,gBAAe;IACf,mBAAkB;IAClB,cAAa,EAEQ;IAnBzB;MAmBM,eAAc,EAAG","file":"style.sass","sourcesContent":["html, body, div, span, applet, object, iframe, h1, h2, h3, h4, h5, h6, p, blockquote, pre, a, abbr, acronym, address, big, cite, code, del, dfn, em, img, ins, kbd, q, s, samp, small, strike, strong, sub, sup, tt, var, b, u, i, center, dl, dt, dd, ol, ul, li, fieldset, form, label, legend, table, caption, tbody, tfoot, thead, tr, th, td, article, aside, canvas, details, embed, figure, figcaption, footer, header, hgroup, menu, nav, output, ruby, section, summary, time, mark, audio, video {\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\tfont-size: 100%;\n\tfont: inherit;\n\tvertical-align: baseline;\n\tbox-sizing: border-box; }\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure, footer, header, hgroup, menu, nav, section {\n\tdisplay: block; }\n\nbody {\n\tline-height: 1; }\n\nol, ul {\n\tlist-style: none; }\n\nblockquote, q {\n\tquotes: none; }\n\nblockquote:before, blockquote:after, q:before, q:after {\n\tcontent: '';\n\tcontent: none; }\n\ntable {\n\tborder-collapse: collapse;\n\tborder-spacing: 0; }\n","header {\n  padding: 10px;\n  background-image: linear-gradient(-180deg, rgba(237,234,237,0.45) 0%, rgba(223,219,223,0.45) 100%);\n  -webkit-app-region: drag;\n  border-bottom: 1px solid darken($primaryBackground, 15);\n  height: 82px;\n\n  #appTitle {\n    text-align: center;\n    font-size: 14px; }\n\n  ul.centeredPills {\n    display: flex;\n    justify-content: space-around;\n    margin-top: 14px;\n\n    li.tab {\n      background: rgba(243, 243, 243, 0);\n      box-sizing: border-box;\n      -webkit-app-region: no-drag;\n      margin-top: 4px;\n      &:hover {\n        background: rgba(243, 243, 243, 0); }\n      &:focus {\n        outline: 1px solid $primaryText; }\n\n      a {\n        padding: 7px 20px;\n        font-size: 13px;\n        text-transform: uppercase;\n        text-decoration: none;\n        cursor: default;\n        color: $primaryText;\n        transition-duration: .2s;\n        border-radius: 5px;\n        &:hover {\n          background: rgba(243, 243, 243, 0.3);\n          padding: 7px 20px; } } }\n\n    li.tab.active {\n      background: $primaryBackground;\n      color: $primaryText;\n\n      // Override bootstrap default styles\n      a {\n        background: $primaryBackground;\n        color: $primaryText;\n        border: .5px solid lighten($primaryBackground, .2);\n        padding: 7px 20px;\n        font-size: 13px;\n        &:focus, &:hover {\n          background: $primaryBackground;\n          color: $primaryText; } } } } }\n","$primaryText: #333;\n$primaryBackground: rgb(243, 243, 243);\n$accent: #4181ec;\n\n@import \"reset\";\n@import \"header\";\n@import \"first-start\";\n@import \"player\";\n@import \"cards\";\n\nbody {\n  margin: 0;\n  font: caption;\n  //-webkit-user-select: none\n  background: rgba(243, 243, 243, 0);\n  user-select: none;\n  cursor: default;\n  outline: none;\n\n  .content {\n    min-height: calc(100vh - 82px);\n    top: 82px;\n    bottom: 0;\n    background: rgb(243, 243, 243);\n    width: 100vw;\n    position: fixed;\n    overflow-y: scroll;\n    display: none;\n    &.active {\n      display: block; } } }\n",".firstStart {\n  text-align: center;\n  height: calc(100vh - 79px);\n  display: flex;\n  padding: 10px 50px;\n  flex-direction: column;\n  justify-content: center;\n  z-index: 100;\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  background: $primaryBackground;\n\n  p {\n    margin: 25px auto 0 auto; } }\n\n.firstStart.draggedOver {\n  background: $accent;\n  color: $primaryBackground;\n\n  button {\n    visibility: hidden; } }\n",".player {\n  height: 82px;\n  width: 100%;\n  position: fixed;\n  bottom: 0;\n  transform: translateY(90px);\n  transition: 0.2s transform;\n  will-change: transform;\n  flex-direction: row;\n  justify-content: space-between;\n  padding: 10px 10px 10px 0;\n  color: $primaryText;\n  background-image: linear-gradient(-180deg, rgba(235, 234, 237, 0.45) 0%, rgba(223, 219, 223, 0.45) 100%);\n  display: none;\n\n  #timeControl {\n    width: 100%;\n    position: absolute;\n    bottom: 82px;\n    z-index: 300;\n    -webkit-appearance: none;\n    width: 100%;\n    border-radius: 4px;\n    height: 4px;\n    background-color: $primaryBackground;\n    box-shadow: 0 -1px 1px 0 rgba(0, 0, 0, 0.25);\n    outline: none; }\n\n  .art {\n    // background: url(../images/album-art-default.svg)\n    background: teal;\n    background-size: cover;\n    margin-left: 10px;\n    width: 62px;\n    height: 62px;\n    min-width: 62px;\n    border-radius: 2px; }\n\n  .data {\n    display: flex;\n    flex: 1;\n    margin: 0 6px;\n    flex-direction: column;\n    justify-content: space-between;\n    // allows text ellipsis despite flexbox\n    min-width: 0;\n\n    .title {\n      margin-bottom: 6px;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis; }\n\n    .artist {\n      opacity: .6;\n      margin-bottom: 4px;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis; }\n\n    .mediaControls {\n      display: flex;\n      flex-direction: row;\n      justify-content: space-between;\n      flex-wrap: wrap;\n      width: 100px;\n      flex: 1;\n      height: 25px;\n\n      div {\n        width: 25px;\n        height: 25px; }\n\n      .previous {\n        background: url(../images/previous_light.png);\n        background-size: cover; }\n\n      .playpause {\n        background: url(../images/play_light.png);\n        background-size: cover; }\n      .playpause.playing {\n        background: url(../images/pause_light.png);\n        background-size: cover; }\n\n      .next {\n        background: url(../images/next_light.png);\n        background-size: cover; } } }\n\n  .volume {\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n\n    input {\n      -webkit-appearance: slider-vertical;\n      height: 80px;\n      align-self: flex-end;\n      width: 20px; }\n\n    div {\n      width: 25px;\n      height: 25px;\n      background: url(../images/soundon_light.png);\n      background-size: cover;\n      align-self: flex-end;\n      width: 20px;\n      margin-bottom: 3px; }\n\n    div.muted {\n      background: url(../images/soundoff_light.png);\n      background-size: cover; } } }\n",".card {\n  height: 60px;\n  padding: 10px;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  color: $primaryText;\n  &:nth-child(even) {\n    background: darken($primaryBackground, 2.7); }\n\n  .card__art {\n    height: 40px;\n    width: 40px;\n    // background: url(../images/album-art-default.svg)\n    background: #ddaaaa;\n    background-size: cover;\n    border-right: 3px;\n    margin-right: 10px; }\n\n  .card__info {\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    padding: 1px 0;\n    // allows text ellipsis despite flexbox\n    min-width: 0;\n\n    p {\n      margin: 0;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis; }\n\n    .card__details {\n      opacity: .6; } } }\n"],"sourceRoot":""}]);
